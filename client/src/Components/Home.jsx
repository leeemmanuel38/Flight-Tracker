...
export default class Home extends Component {
    ...
    constructor(props){
      ...
      handleLogoutClick = (event) => {
        ...
        localStorage.clear(); // remove local session 
        history.push('./');  // redirect back to default home page 
    };

    render() {
        // retrieve authentication value from local storage 
                        ...
                        <div className="Navbar">
                            ...
                            <Navbar bg= "primary" variant="dark">
                                ...
                                <div class="btn">
                                    ...
                                    <button type="Submit"  
                                        onClick={(event) => {this.handleLogoutClick(event)}} class="btn btn-success btn-lg">Logout </button>
                                </div>
                            </Navbar> 
                            <br/>
                        </div>
